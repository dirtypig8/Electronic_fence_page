...
function fn_del_fence(on_success){
	$.ajax({
	  ...
	  url: "http://127.0.0.1/Electronic_fence_page/allowed_person/del_fence.php",  //請求的頁面
...
function update_alarm(on_success){
	$.ajax({
	  type: 'POST',                     //GET or POST
	  url: "http://127.0.0.1/Electronic_fence_page/allowed_person/select_area.php",  //請求的頁面
