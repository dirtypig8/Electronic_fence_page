	...
	<div class="container">
		<div class="row" >
			<div class="col-md-4 text-center">
					...
					<button type="button" class="btn btn-primary btn-lg btn-block" id="select_area_bt">查詢圍籬代號</button>
				<br/>
				<ul class="list-group-item active">目前圍籬</ul>
